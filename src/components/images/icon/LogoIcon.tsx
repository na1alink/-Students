const LogoIcon = ({ className = "" }) => (
  ...
  >
    <path
      d="M29.4322 34.0151C35.0338 31.0603 37.1442 24 34.148 18.2995C31.1518 12.599 24.1693 10.3763 18.5678 13.3311C12.9662 16.286 10.8558 23.3463 13.852 29.0468C16.8482 34.7473 23.8306 36.97 29.4322 34.0151Z"
      stroke="#49C2E8"
      strokeWidth="5"
      strokeMiterlimit="10"
    />
